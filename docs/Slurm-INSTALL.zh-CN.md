...
[English](Slurm-INSTALL.md) | **简体中文**

本文只负责把每台 Ubuntu 22.04 `amd64` 主机统一到支持 cgroup v2 的 Slurm 26.05.2。集群节点参数、Munge 分发和启动顺序见 [Slurm 集群收尾](06-cluster-finalization.zh-CN.md)。
