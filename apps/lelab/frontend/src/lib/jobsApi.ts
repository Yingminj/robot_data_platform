...
export interface JobRecord {
  ...
  runner: "local" | "hf_cloud" | "slurm" | "imported";
...
export async function getClusterStatus(
  ...
  return apiRequest<ClusterStatus>(baseUrl, fetcher, "/cluster/status", {
    signal,
...
export async function listModelTemplates(
  ...
  const body = await apiRequest<{ templates: ModelTemplate[] }>(
    baseUrl,
    fetcher,
    "/cluster/templates",
    { signal, action: "List model templates" },
  );
